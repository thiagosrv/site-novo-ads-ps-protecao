...
const FAQ_SCHEMA = {
  ...
  mainEntity: FAQ_ITEMS.map((item) => ({
    "@type": "Question",
    name: stripFaqMarkup(item.question),
    acceptedAnswer: {
      "@type": "Answer",
